    ...
    <div id="about" className="scroll">
      <div className="section">
        ...
        <div className="container">
          ...
          <p>Previously, I worked as a Legal Assistant at Trainline. Supporting the Legal team, as well as other functions and missions. These included procurement functions, Government Relations teams and various sustainability and CSR missions. As part of my time at Trainline, I opted into a Level 1 coding course run by Code First: Girls and absolutely loved it. Fast forward 2 years, a pandemic, and some tough times, I decided to embark on the challenge that is 'the coding'. I enrolled on General Assembly's Software Engineering Immersive course and haven't looked back.</p>
